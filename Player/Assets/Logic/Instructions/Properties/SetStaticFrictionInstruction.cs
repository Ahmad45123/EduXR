...
namespace Assets.Logic.Instructions.Properties {
    public class SetStaticFrictionInstruction : ExecInstruction {
        public SetStaticFrictionInstruction(Dictionary<string, InputParam> inputs, Dictionary<string, string> parms, Dictionary<string, ExecInstruction> nxtInstructions) : base(inputs, parms, nxtInstructions) { }
